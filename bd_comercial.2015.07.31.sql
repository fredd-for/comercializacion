...
CREATE TABLE `contratos` (
  ...
  PRIMARY KEY (`id`),
  KEY `clientes_contratos_fk` (`cliente_id`) USING BTREE,
  CONSTRAINT `contratos_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `contratos` VALUES (1,'007/2015',7,'2015-07-31 19:40:14',643,'2015-07-22 17:09:48',1,'EMPRESA ESTATAL DE TRASPORTE POR CABLE ','LIC. CESAR LUIS DOCKWEILER SUAREA','GERENTE EJECUTIVO','Alquiler de una caseta comercial para la venta de flores en la EstaciÃ³n Ajayuni.',0,0.00,643,NULL,1,'2015-07-31 14:01:31','qqq',635),(2,'006/2015',2,'2015-07-31 19:40:18',643,'2015-07-22 17:30:01',1,'EMPRESA ESTATAL DE TRASPORTE POR CABLE ','LIC. CESAR LUIS DOCKWEILER SUAREA','GERENTE EJECUTIVO','Alquiler de una caseta comercial para la venta de flores en la EstaciÃ³n Ajayuni.',0,0.00,643,NULL,1,'2015-07-31 19:38:56','qqqqwwww',635),(3,'004/2015',3,'2015-03-02 04:00:00',643,'2015-07-22 18:58:11',1,'EMPRESA ESTATAL DE TRASPORTE POR CABLE ','LIC. CESAR LUIS DOCKWEILER SUAREA','GERENTE EJECUTIVO','Alquiler de una caseta comercial para la venta de flores en la EstaciÃ³n Ajayuni.',0,0.00,643,NULL,1,NULL,NULL,NULL),(4,'003/2015',4,'2015-07-31 19:40:20',643,'2015-07-23 09:44:29',1,'EMPRESA ESTATAL DE TRASPORTE POR CABLE ','LIC. CESAR LUIS DOCKWEILER SUAREA','GERENTE EJECUTIVO','Alquiler de una caseta comercial para la venta de flores en la EstaciÃ³n Ajayuni.',0,0.00,643,10,1,'2015-07-31 19:36:29','1qqq',635),(5,'009/2015',1,'2015-07-31 19:40:21',643,'2015-07-23 10:05:00',1,'EMPRESA ESTATAL DE TRASPORTE POR CABLE ','LIC. CESAR LUIS DOCKWEILER SUAREA','GERENTE EJECUTIVO','Alquiler de una caseta comercial para la venta de helados en la EstaciÃ³n Ajayuni.',0,0.00,643,14,3,'2015-07-31 20:49:38','qqq',635),(6,'010/2015',5,'2015-07-31 19:40:22',643,'2015-07-23 10:20:48',1,'EMPRESA ESTATAL DE TRASPORTE POR CABLE ','LIC. CESAR LUIS DOCKWEILER SUAREA','GERENTE EJECUTIVO','Alquiler de una caseta comercial para la venta de helados en la EstaciÃ³n Ajayuni.',0,0.00,643,12,2,'2015-07-31 20:02:24','qqqq',635),(7,'008/2015',6,'2015-07-31 19:40:25',643,'2015-07-23 10:34:45',1,'EMPRESA ESTATAL DE TRASPORTE POR CABLE ','LIC. CESAR LUIS DOCKWEILER SUAREA','GERENTE EJECUTIVO','Alquiler de una caseta comercial para la venta de helados en la EstaciÃ³n Ajayuni',0,0.00,643,13,3,'2015-07-31 19:46:37','para su consideracion',635),(8,'011/2015',2,'2015-07-31 20:33:03',635,'2015-07-27 17:14:42',1,'EMPRESA ESTATAL DE TRASPORTE POR CABLE ','LIC. CESAR LUIS DOCKWEILER SUAREA','GERENTE EJECUTIVO','alquiler de 2 productos con diferentes fechas de finalizacion',5,0.00,640,0,3,'2015-07-31 20:34:02','qqqq',635);
...
CREATE TABLE `contratosproductos` (
  ...
  `usuario_finalizacion` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `contratos_contratosproductos_fk` (`contrato_id`) USING BTREE,
  KEY `productos_contratosproductos_fk` (`producto_id`) USING BTREE,
  CONSTRAINT `contratosproductos_ibfk_1` FOREIGN KEY (`contrato_id`) REFERENCES `contratos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `contratosproductos_ibfk_2` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `contratosproductos` VALUES (1,1,15,1392.00,'Mensual','2015-04-01 00:00:00','2016-03-31 00:00:00',1,1,16704.00,366,3,'2015-07-31 14:01:31','qqq',635),(2,1,16,1392.00,'Mensual','2015-05-01 00:00:00','2015-04-30 00:00:00',0,1,1392.00,2,1,NULL,NULL,NULL),(3,2,16,1392.00,'Mensual','2015-05-01 00:00:00','2016-04-30 00:00:00',1,1,16704.00,366,3,'2015-07-31 19:39:17','qqqqwwww',635),(4,3,17,1392.00,'Mensual','2015-05-01 00:00:00','2016-04-30 00:00:00',1,1,16704.00,366,1,NULL,NULL,NULL),(5,4,18,1392.00,'Mensual','2015-04-01 00:00:00','2016-03-31 00:00:00',1,1,16704.00,366,2,'2015-07-31 19:36:30','1qqq',635),(6,5,13,1392.00,'Mensual','2015-04-01 00:00:00','2016-03-31 00:00:00',1,1,16704.00,366,2,'2015-07-31 19:25:41','concluido correctamente',635),(7,6,12,1392.00,'Mensual','2015-04-01 00:00:00','2016-03-31 00:00:00',1,1,16704.00,366,4,'2015-07-31 19:23:21','para su consideracion',635),(8,7,14,1392.00,'Mensual','2015-04-01 00:00:00','2016-03-31 00:00:00',1,1,16704.00,366,3,'2015-07-31 19:04:42','fffff',635),(9,8,1,2610.00,'Mensual','2015-07-01 00:00:00','2015-11-30 00:00:00',1,1,13050.00,153,3,'2015-07-31 20:34:02','qqqq',635),(10,8,2,2610.00,'Mensual','2015-07-01 00:00:00','2015-09-30 00:00:00',1,1,7830.00,92,2,'2015-07-31 20:33:43','1ra vez',635),(11,1,1,2610.00,'Mensual','2015-07-01 00:00:00','2015-07-31 00:00:00',0,1,2610.00,31,1,NULL,NULL,NULL);
...
CREATE TABLE `estaciones` (
  ...
  `baja_logica` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `lineas_estaciones_fk` (`linea_id`) USING BTREE,
  CONSTRAINT `estaciones_ibfk_1` FOREIGN KEY (`linea_id`) REFERENCES `lineas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `parametros` VALUES (1,'solicitudes_estados','Proceso',NULL,NULL,NULL,0,1,1),(2,'solicitudes_estados','Aceptado',NULL,NULL,NULL,0,1,2),(3,'solicitudes_estados','Rechazado',NULL,NULL,NULL,0,1,3),(4,'contratos_estados','Vigente',NULL,NULL,NULL,0,1,1),(5,'contratos_estados','Concluido correctamente',NULL,NULL,NULL,0,1,2),(6,'contratos_estados','Recindir por incumplimiento de pago',NULL,NULL,NULL,0,1,3),(7,'contratos_estados','Recindir por falta de producto',NULL,NULL,NULL,0,1,4);
...
CREATE TABLE `productos` (
  ...
  PRIMARY KEY (`id`),
  KEY `estaciones_productos_fk` (`estacion_id`) USING BTREE,
  KEY `grupos_productos_fk` (`grupo_id`) USING BTREE,
  CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`estacion_id`) REFERENCES `estaciones` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `productos_ibfk_2` FOREIGN KEY (`grupo_id`) REFERENCES `grupos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `solicitudesproductos` (
  ...
  `estado` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `solicitudes_solicitudesproductos_fk` (`solicitud_id`) USING BTREE,
  KEY `productos_solicitudesproductos_fk` (`producto_id`) USING BTREE,
  CONSTRAINT `solicitudesproductos_ibfk_1` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `solicitudesproductos_ibfk_2` FOREIGN KEY (`solicitud_id`) REFERENCES `solicitudes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `solicitudesproductos` VALUES (6,7,1,2610.00,'Mensual',NULL,NULL,0,1,NULL,NULL,1),(7,13,14,1392.00,'Mensual',NULL,NULL,1,1,NULL,NULL,1),(8,9,17,1392.00,'Mensual',NULL,NULL,1,1,NULL,NULL,1),(9,10,18,1392.00,'Mensual',NULL,NULL,1,1,NULL,NULL,1),(10,12,12,1392.00,'Mensual',NULL,NULL,1,1,NULL,NULL,1);
...
INSERT INTO `usuarios` VALUES (629,'gsanchez',0,1,1,'b6c56905f53fbea5b1acb6f28d4e8d61940b7c99c80b5e765e9762fc069f13f9','Gaby','GS','Jefe Dpto. Comercializacion','gsanchez@miteleferico.bo',2,NULL,1,2,'1',NULL,1,1,4021525,'OR',NULL,1,'Sanchez','BolaÃ±os',NULL),(635,'fvelasco',0,1,1,'b374537609b09ea5376e4b8baad6b2809f495b72e9a615531ee33e980ff094c0','Luis Freddy','FV','Profesioanl en desarrollo de sistemas','fvelasco@miteleferico.bo',475,NULL,1,2,'1',NULL,1,1,4986493,'LP',NULL,1,'Velasco','Poma',NULL),(637,'psalinas',0,1,1,'b6c56905f53fbea5b1acb6f28d4e8d61940b7c99c80b5e765e9762fc069f13f9','Pablo','PS','Gerente de Gestion Empresial','psalinas@miteleferico.bo',6,NULL,1,2,'1',NULL,1,1,4098897,'LP',NULL,1,'Salinas','Burgos',NULL),(640,'spenaloza',0,1,1,'b6c56905f53fbea5b1acb6f28d4e8d61940b7c99c80b5e765e9762fc069f13f9','Sergio','PD','Profesional en Comercializacio Marketing y Ventas','spenaloza@miteleferico.bo',2,NULL,1,2,'1',NULL,1,1,4096997,'LP',NULL,1,'PeÃ±aloza','Solares',NULL),(641,'jvera',0,1,1,'b6c56905f53fbea5b1acb6f28d4e8d61940b7c99c80b5e765e9762fc069f13f9','Juan Esteban','FBS','Profesional en Comercializacio Marketing y Ventas','jvera@miteleferico.bo',3,NULL,1,2,'1',NULL,1,1,4567788,'LP',NULL,1,'Vera','Callau',NULL),(643,'adaza',0,1,1,'b6c56905f53fbea5b1acb6f28d4e8d61940b7c99c80b5e765e9762fc069f13f9','Ariana','EMV','Profesional en Comercializacio Marketing y Ventas','adaza@miteleferico.bo',18,NULL,1,2,'1',NULL,1,1,4567747,'LP',NULL,1,'Daza','Goytia',NULL),(644,'cvidaurre',0,1,1,'b6c56905f53fbea5b1acb6f28d4e8d61940b7c99c80b5e765e9762fc069f13f9','Carla','MLY','Profesional en Comercializacio Marketing y Ventas','cvidaurre@miteleferico.bo',3,NULL,1,2,'1',NULL,1,1,4557897,'LP',NULL,1,'Vidaurre','Caballero',NULL),(645,'jtinini',0,1,1,'b6c56905f53fbea5b1acb6f28d4e8d61940b7c99c80b5e765e9762fc069f13f9','Juan','JT','Responsable de Contabilidad','jloza@miteleferico.bo',1,NULL,1,4,'1',NULL,1,1,4985549,'LP',NULL,1,'Tinini','Tinini',NULL),(646,'saruquipa',0,1,1,'b6c56905f53fbea5b1acb6f28d4e8d61940b7c99c80b5e765e9762fc069f13f9','Sonia','SA','Profesional en comercializacion','saruquipa@miteleferico.bo',6,0,1,2,'1',0,1,1,420625,'LP',NULL,1,'Aruquipa','Quispesala',NULL),(647,'pburgos',0,1,1,'b6c56905f53fbea5b1acb6f28d4e8d61940b7c99c80b5e765e9762fc069f13f9','Pamela','PB','Consultor en Desarrollo, Penetracion y Mantenimiento de Mercado','pburgos@miteleferico.bo',1,2015,1,2,'1',0,1,1,5817699,'LP',NULL,1,'Burgos','Chungara',NULL);
...
-- Dump completed on 2015-07-31 19:22:17
