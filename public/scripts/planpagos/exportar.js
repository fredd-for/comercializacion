...
function exportarReporte(option){
    ...
    fecha_contrato = $('#jqxgrid').jqxGrid('getcolumn','fecha_contrato');
    fecha_inicio = $('#jqxgrid').jqxGrid('getcolumn','fecha_inicio');
    fecha_fin = $('#jqxgrid').jqxGrid('getcolumn','fecha_fin');
    total = $('#jqxgrid').jqxGrid('getcolumn','total');
    deposito = $('#jqxgrid').jqxGrid('getcolumn','deposito');
    cobrar = $('#jqxgrid').jqxGrid('getcolumn','cobrar');
    mora = $('#jqxgrid').jqxGrid('getcolumn','mora');
    ...
    columna[fecha_contrato.datafield] = {text: fecha_contrato.text, hidden: fecha_contrato.hidden};
    columna[producto.datafield] = {text: producto.text, hidden: producto.hidden};
    columna[fecha_inicio.datafield] = {text: fecha_inicio.text, hidden: fecha_inicio.hidden};
    columna[fecha_fin.datafield] = {text: fecha_fin.text, hidden: fecha_fin.hidden};
    columna[total.datafield] = {text: total.text, hidden: total.hidden};
    columna[deposito.datafield] = {text: deposito.text, hidden: deposito.hidden};
    columna[cobrar.datafield] = {text: cobrar.text, hidden: cobrar.hidden};
    columna[mora.datafield] = {text: mora.text, hidden: mora.hidden};
    ...
    var ruta='';
    switch (option){
        case 1: ruta="/planpagos/exportexcel/";break;
        case 2: ruta="/planpagos/exportpdf/";break;
    }
    if(ruta!='')
